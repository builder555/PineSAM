...
const settingDescriptions = {
  DCInCutoff: {
    ...
    description:
      "Set cutoff voltage to prevent battery overdrainage (DC 10V) (S=3.3V per cell, disable PWR limit)",
  },
  MinVolCell: {
  ...
  CalibrateCJC: {
    ...
    description:
      "Calbrate Cold Junction Compensation at next boot (not required if Delta T is < 5°C)",
  },
  VoltageCalibration: {
